...
RepositoryMappingService.DATA_DIR = path.join(__dirname, '../../data');
RepositoryMappingService.MAPPINGS_FILE = path.join(RepositoryMappingService.DATA_DIR, 'repo-mappings.json');
